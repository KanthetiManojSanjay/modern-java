...
class DaysInMonthTest {
    ...
    @ParameterizedTest
    @MethodSource("input")
    void getDaysUsingEnhancedSwitch(Month month, int expectedNoOfDays) {
        int days = DaysInMonth.getDaysUsingEnhancedSwitch(month, 2023);
        assertEquals(expectedNoOfDays, days);
    }
    ...
    @ParameterizedTest
    @MethodSource("input")
    void getDaysUsingEnhancedSwitchExhaustive(Month month, int expectedNoOfDays) {
        int days = DaysInMonth.getDaysUsingEnhancedSwitchExhaustive(month, 2023);
        assertEquals(expectedNoOfDays, days);
    }
